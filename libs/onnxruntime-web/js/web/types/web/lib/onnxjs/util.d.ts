...
export declare class LongUtil {
    static longToNumber(n: Long | flatbuffers.Long | number): number;
...
export declare class ShapeUtil {
     ...
     */
    static calculateReshapedDims(originalDims: readonly number[], shapeHints: number[] | readonly number[] | Tensor.IntegerType): readonly number[];
    /**
...
export declare class PoolConvUtil {
     ...
     */
    static adjustPoolAttributes(isGlobalOperator: boolean, inputDims: readonly number[], kernelShape: number[], strides: number[], pads: number[]): void;
    static adjustPadsBasedOnAutoPad(inputDims: readonly number[], strides: number[], dilations: number[], kernelShape: number[], pads: number[], autoPad?: string): void;
    /**
     ...
     */
    static computePoolOutputShape(isGlobalOperator: boolean, inputDims: readonly number[], strides: number[], kernelShape: number[], pads: number[], autoPad?: string): number[];
    /**
